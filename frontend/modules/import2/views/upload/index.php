        ...
        <div class="col-xs-6">
            <?php if (MyHelper::user_can('Admin')): ?>
                <div class="button-group pull-right">
                    <?= Html::a('<i class="glyphicon glyphicon-info-sign"></i> ข้อผิดพลาด', ['/import2/import-error/index'], ['class' => 'btn btn-red']) ?>
                </div>
            <div class="button-group pull-right" style="margin-right: 5px">
                    <?= Html::a("รอนำเข้า $zip", ['/import2/upload/importall'], ['class' => 'btn btn-green']) ?>
                </div>
