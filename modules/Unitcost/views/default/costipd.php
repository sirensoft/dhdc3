...
$this->params['breadcrumbs'][] = "ต้นทุนความค่าบริการ ผู้ป่วยใน";
?>
<div class="well">
<?php 
	$form = ActiveForm::begin([
				'method'=>'Post',
				'action'=>Url::to(['/Unitcost/default/costipd']),
			]);
?>
    <div class="row">
        <div class="col-sm-3">
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => ['before' => '<h3>ต้นทุนความค่าบริการ ผู้ป่วยใน Unitcost '.$hosname.' ปีงบ '.$BYEAR.'</h3>'],
    'columns' => [
        //'HOSPCODE',
        'INCOME',
        'INCOME_NAME',
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ต้นทุนความค่าบริการ ผู้ป่วยใน'
    },
    subtitle: {
        text: ''
    },
