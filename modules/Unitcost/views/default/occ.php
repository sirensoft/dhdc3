...
$this->params['breadcrumbs'][] = "ต้นทุนความค่าบริการ แยกอาชีพ";
?>
...
<?php 
	$form = ActiveForm::begin([
				'method'=>'Post',
				'action'=>Url::to(['/Unitcost/default/occ']),
			]);
?>
    <div class="row">
        <div class="col-sm-3">
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => ['before' => '<h3>ต้นทุนความค่าบริการ แยกอาชีพ '.$hosname.' ปีงบ '.$BYEAR.'</h3>'],
    'columns' => [
        //'HOSPCODE',
        'OCC_NAME',
        [
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ต้นทุนความค่าบริการ แยกอาชีพ $hosname'
    },
    subtitle: {
        text: ''
    },
