...
$this->params['breadcrumbs'][] = "ต้นทุนความค่าบริการ แยกสัญชาติ AEC";
?>
...
<?php 
	$form = ActiveForm::begin([
				'method'=>'Post',
				'action'=>Url::to(['/Unitcost/default/aec']),
			]);
?>
    <div class="row">
    <div class="col-sm-3">
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => ['before' => '<h3>ต้นทุนความค่าบริการ แยกสัญชาติ AEC '.$hosname.'</h3>'],
    'columns' => [
        //'HOSPCODE',
        'NATION_GROUP_NAME',
        [
...
foreach($raw as $value){
        $categories[] = $value['NATION_GROUP_NAME'];
}
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ต้นทุนความค่าบริการ แยกสัญชาติ AEC $hosname'
    },
    subtitle: {
        text: ''
    },
