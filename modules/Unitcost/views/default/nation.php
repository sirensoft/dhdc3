...
$this->params['breadcrumbs'][] = "ต้นทุนความค่าบริการ แยกสัญชาติ";
?>
...
<?php 
	$form = ActiveForm::begin([
				'method'=>'Post',
				'action'=>Url::to(['/Unitcost/default/nation']),
			]);
?>
    <div class="row">
        <div class="col-sm-3">
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => ['before' => '<h3>ต้นทุนความค่าบริการ แยกสัญชาติ '.$hosname.' ปีงบ '.$BYEAR.'</h3>'],
    'columns' => [
        //'HOSPCODE',
        'NATION_NAME',
        [
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ต้นทุนความค่าบริการ แยกสัญชาติ $hosname'
    },
    subtitle: {
        text: ''
    },
