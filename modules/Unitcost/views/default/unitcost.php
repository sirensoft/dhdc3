...
use modules\Unitcost\models\Cbyear;
...
$this->params['breadcrumbs'][] = "ต้นทุนความค่าบริการ";
?>
...
<?php 
	$form = ActiveForm::begin([
				'method'=>'Post',
				'action'=>Url::to(['/Unitcost/default/unitcost']),
			]);
?>
    <div class="row">
        <div class="col-sm-3">
...
echo \kartik\grid\GridView::widget([
    ...
    'panel' => ['before' => '<h3>ข้อมูลต้นทุนความค่าบริการ Unitcost '.$hosname.' ปีงบ '.$BYEAR.'</h3>'],
    'columns' => [
        //'HOSPCODE',
        'INCOME',
        'INCOME_NAME',
...
Highcharts.chart('container', {
    ...
    title: {
        text: 'ต้นทุนความค่าบริการ $hosname'
    },
    subtitle: {
        text: ''
    },
